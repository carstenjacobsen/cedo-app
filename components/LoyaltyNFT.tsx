/* ************************************************ */
/* LoyaltyNFT shows all NFTs for a given vendor.    */
/* This is a view-only modal                        */
/* ************************************************ */
...
export default function LoyaltyNFT(props: NFTprops): React.JSX.Element {
    ...
    return (
      ...
      <Card>
        ...
        <Card.Content>
          <Text variant="titleLarge">10% Off Discount {props.list}</Text>
